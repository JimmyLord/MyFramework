...
{
#if MYFW_WP8
    const char* pathstr = "ms-appdata:///local/"; // TODO: replace with the docs and settings or something...
#else
    const char* pathstr = "./"; // TODO: replace with the docs and settings or something...
#endif
